                ...
                <div class="panel-body">
                    ...
                    <div class="wizard-content">
                        ...
                        if ($dados_usuario == NULL) {
                            include('formulario-quatro.php');
                        } else {
                            include('infos.php');
                        }

                        $sql2 = "SELECT id_familiares FROM familiares where id_usuario = '$id_usuario' ";
                    ...
                    <div class="wizard-buttons">
                        <a class="btn btn-default btn-outline" href="fumec-form-3" role="button">Voltar</a>

                        <?php if(!isset($dados_usuario2['id_familiares'])) {
                            ?>
                            <button class="btn btn-primary btn-outline float-right" href="fumec-form-5" role="button" disabled>Avançar</button>
                        <?php
                        } else {
                        ?>
                            <a class="btn btn-primary btn-outline float-right" href="fumec-form-5" role="button">Avançar</a>
                        <?php
                        }
                        ?>
                    </div>
