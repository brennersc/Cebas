        ...
        <div class="col-12">
            ...
            <div class="panel">
                <div class="panel-heading">
                    <!-- <h3 class="panel-title">Bolsa Oportunidade FUMEC</h3> --><br>
                </div>
                <div class="panel-body">
                    ...
                    <div class="steps steps-sm row" data-plugin="matchHeight" data-by-row="true" role="tablist">
                        ...
                        <div class="step col-lg-3 current" data-target="#exampleBilling" role="tab">
                    ...
                    <div class="wizard-buttons">
                        <a class="btn btn-default btn-outline" href="fumec-form" role="button">Voltar</a>
                        <?php if (!isset($dados_usuario2['id_curso'])){ ?>
                            <button class="btn btn-primary btn-outline float-right" href="#" role="button" disabled>Avançar</button>
                        <?php } else { ?>
                            <a class="btn btn-primary btn-outline float-right" href="fumec-form-3" role="button">Avançar</a>
                        <?php  }  ?>
                    </div>
