...
<body class="animsition">
    ...
    <div class="page">
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="fumec-form-3.php">Profissão</a></li>
                <li class="breadcrumb-item">Moradia</li> -->
        ...
        <!-- FOMULARIOS -->
        <?php include('conteudo-formulario4/form-insc-4.php'); ?>
        <!-- FOMULARIOS -->
    </div>
    <!-- End Page -->
    ...
    <script type="text/javascript">
        ...
        // O candidato reside com o grupo familiar?
        $(".reside").change(function() {
            if ($("#sim").prop("checked") == true) {
                $('#campo_reside').fadeIn("show");
            } else {
                $('#campo_reside').hide();
            }
        });
