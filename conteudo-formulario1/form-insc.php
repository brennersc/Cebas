            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="wizard-buttons">
                        <?php if (!isset($dados_usuario2['id_cadastro'])) { ?>
                            <button class="btn btn-primary btn-outline float-right" href="" role="button" disabled>Avançar</button>
                        <?php } else { ?>
                            <a class="btn btn-primary btn-outline float-right" href="fumec-form-2" role="button">Avançar</a>
                        <?php } ?>
                    </div>
