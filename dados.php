    ...
    <div class="page">
        <div class="page-header">
            ...
            <div class="page-header-actions">
                <a class="btn btn-sm btn-default btn-outline btn-round" href="http://www.fumec.br/" target="_blank">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="steps steps-sm row" data-plugin="matchHeight" data-by-row="true" role="tablist">
                                ...
                                <div class="step col-lg-12" data-target="#exampleAccount" role="tab">
                                    <span class="step-number" style="background: #0000;"><i class="icon wb-info-circle" aria-hidden="true" style="font-size: 30px; color: #9a9a9a"></i></span>
                                    <div class="step-desc">
                                        <span class="step-title">Dados Cadastrados</span>
                            ...
                            <div class="wizard-content">
                                <!-- Primeiro -->
                                <?php include('conteudo-formulario1/infos.php'); ?>
                                <!-- Segundo -->
                                <?php include('conteudo-formulario2/infos.php'); ?>
                                <!-- Terceiro -->
                                <?php include('conteudo-formulario3/infos.php'); ?>
                                <!-- Quarto -->
                                <?php include('conteudo-formulario4/infos.php'); ?>
